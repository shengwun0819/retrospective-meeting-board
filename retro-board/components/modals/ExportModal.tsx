  ...
  if (Array.isArray(value)) {
    ...
    return (
      <span>
        ...
        {open && (
          <div className="pl-4 border-l border-gray-100 ml-1 mt-0.5 space-y-0.5">
            {value.map((item, i) => (
...
export default function ExportModal({ sessionId, payload, loading, onClose }: ExportModalProps) {
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] flex flex-col">
        ...
        <div className="p-5 border-b border-gray-200 flex items-center justify-between shrink-0">
          <div>
            ...
            <p className="text-xs text-gray-400 mt-0.5">Writes to your ClickUp doc via ClickUp MCP Server</p>
          </div>
  ...
  "env": { "CLICKUP_AUTH_TYPE": "oauth" }
              ...
              <div className="bg-gray-50 rounded-xl p-4 border border-gray-200 space-y-3">
                <p className="text-sm font-semibold text-gray-700">Step 2: Set export target (optional)</p>
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border border-gray-200 rounded-lg px-3 py-2 text-xs focus:outline-none focus:border-blue-500 transition-colors"
                    />
                  </div>
                  <div>
                ...
                {(!spaceId || !docName) && (
                  <p className="text-xs text-gray-400">Leave blank to use the default hardcoded target.</p>
                )}
              </div>
              ...
              <div className="border border-gray-200 rounded-xl overflow-hidden">
                ...
                <div className="p-4 text-xs font-mono overflow-x-auto max-h-64 overflow-y-auto">
